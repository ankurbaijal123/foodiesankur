...
const RestuarentCard = (props) =>{ /* destructuring on the fly  ---> insted of props written we pass the arguments, react wrap 
  ...
  const{
    ...
    return(
        ...
        <img className="res-logo" src={
          "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_264,h_288,c_fill/"+ cloudinaryImageId } alt="logo-res" />
            <h3>{name}</h3>
            <h4>{cuisines.join(', ')}</h4>
